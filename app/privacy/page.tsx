      ...
      <div className='container grid max-w-2xl gap-10 px-4 md:px-6 lg:gap-16 xl:max-w-3xl xl:gap-20'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-3'>
            ...
            <p className='text-gray-500 dark:text-gray-400'>
              The security of your personal data is important to us. We have put
              in place appropriate security measures to prevent your personal
              data from being accidentally lost, used, or accessed in an
              unauthorized way, altered, or disclosed.
            </p>
          </div>
          <div className='space-y-3'>
            <h2 className='text-2xl font-bold tracking-tight'>Data Sharing</h2>
            <p className='text-gray-500 dark:text-gray-400'>
